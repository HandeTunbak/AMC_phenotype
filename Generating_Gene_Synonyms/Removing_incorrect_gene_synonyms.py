...
Human_gene_synonyms= 'C:/Users/hande/OneDrive - Oxford Brookes University/Documents/Projects/Reverse_approach_(Zebrafish_to_Humans)/Ensembl_Gene_Names_&_Synonyms_v2.csv'
#%%
...
final_df.to_csv((base_folder + '/Human_gene_synonyms_corrected_v2.csv'), index=False)
