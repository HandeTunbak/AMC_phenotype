...
---------------------------------------
Run code in command list if using for the first time  >> in command line
...
https://www.hammerlab.org/2015/02/04/exploring-the-genome-with-ensembl-and-python/ OR https://ftp.ensembl.org/pub/release-109/gtf/homo_sapiens/

---------------------------------------
If running the first time, run the below code below in the anaconda command prompt:    
    $   install --release 109 --species homo_sapiens
The file you need is https://ftp.ensembl.org/pub/release-109/gtf/homo_sapiens/Homo_sapiens.GRCh38.109.gtf.gz
This may take a few minutes    

ALSO need newest version of pandas:
...
folder_path = 'C:/Users/hande/OneDrive - Oxford Brookes University/Documents/Projects/Reverse_approach_(Zebrafish_to_Humans)/BED_file'
## ----------------------------------------------------------------

ensembl = pyensembl.EnsemblRelease(release=109) # by default newer release is used when not specified. 
# Get all gene ids
...
input_folder= ('C:/Users/Hande/OneDrive - Oxford Brookes University/Documents/Projects/Reverse_approach_(Zebrafish_to_Humans)/BED_file/Input')
input_file= os.path.join((input_folder + '/Input_Quiery_Gene_List.xlsx'))
...
output_folder = 'C:/Users/Hande/OneDrive - Oxford Brookes University/Documents/Projects/Reverse_approach_(Zebrafish_to_Humans)/BED_file/Output'
