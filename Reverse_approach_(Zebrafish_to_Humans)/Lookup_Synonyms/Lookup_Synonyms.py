...
file_path= 'C:/Users/Hande/OneDrive - Oxford Brookes University/Documents/Projects/Reverse_approach_(Zebrafish_to_Humans)/Files/Lookup_Synonyms/Input/Summary of filtered genes -panelAPP genes removed_v2.xlsx'

Human_gene_synonyms_path = 'C:/Users/Hande/OneDrive - Oxford Brookes University/Documents/Projects/Reverse_approach_(Zebrafish_to_Humans)/Files/Lookup_Synonyms/Input/Human_gene_synonyms_corrected_v2.csv'
...
## Save   
Anophthalmia_synonyms_list.to_csv((base_folder + '/Lookup_Synonyms/Output ' + '/Anophthalmia_Synonyms' + '/Human_Anophthalmia_Synonyms_MultipleColumns.csv'), index=False)
...
## Save
Unique_Anophthalmia_synonyms_list.to_csv((base_folder + '/Lookup_Synonyms/Output ' + '/Anophthalmia_Synonyms' + '/Human_Anophthalmia_Synonyms_SingleColumn.csv'), index=False)
...
## Save   
Coloboma_synonyms_list.to_csv((base_folder + '/Lookup_Synonyms/Output ' + '/Coloboma_Synonyms' + '/Human_Coloboma_Synonyms_MultipleColumns.csv'), index=False)
...
## Save
Unique_Coloboma_synonyms_list.to_csv((base_folder + '/Lookup_Synonyms/Output ' + '/Coloboma_Synonyms' +'/Human_Coloboma_Synonyms_SingleColumn.csv'), index=False)
...
## Save   
Microphthalmia_synonyms_list.to_csv((base_folder + '/Lookup_Synonyms/Output ' + '/Lookup_Synonyms/Output ' + '/Microphthalmia_Synonyms' + '/Human_Microphthalmia_Synonyms_MultipleColumns.csv'), index=False)
...
## Save
Unique_Microphthalmia_synonyms_list.to_csv((base_folder + '/Lookup_Synonyms/Output ' + '/Microphthalmia_Synonyms' + '/Human_Microphthalmia_Synonyms_SingleColumn.csv'), index=False)
