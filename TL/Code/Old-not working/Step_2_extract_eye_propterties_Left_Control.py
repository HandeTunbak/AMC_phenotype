...
# Eye 
    ...
    eye_threshold = (eye_threshold[0] /1.50)
...
#-------- 
    ...
    cleaned_img_eye_1 = remove_small_objects(eye_mask, min_size=4500, connectivity=1)
...
if filename == 'image_paths_left': 
    ...
    left_eye_parameters_all.to_csv( str(Path(img_paths_left[f]).parents[2]) + '\Left_measurements_pixels.csv')
    ...
    right_eye_parameters_all.to_csv( str(Path(img_paths_right[f]).parents[2]) + '\Right_measurements_pixels.csv')
