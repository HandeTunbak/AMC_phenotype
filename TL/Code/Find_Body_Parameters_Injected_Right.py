...
if condition=='Control' and direction== 'Left':   
    Fish_lengths_all.to_csv( str(Path(img_paths[f]).parents[2]) + '/' + condition + '_Left_Body_Parameters.csv', index=False)


elif condition=='Control' and direction== 'Right':   
    Fish_lengths_all.to_csv( str(Path(img_paths[f]).parents[2]) + '/' + condition + '_Right_Body_Parameters.csv', index=False)
