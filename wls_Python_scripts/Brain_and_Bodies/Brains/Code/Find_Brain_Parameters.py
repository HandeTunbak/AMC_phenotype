...
if condition=='Control' and direction== 'Left':   
    Data.to_csv( str(Path(img_paths[f]).parents[2]) + '/' + condition + '_Left_Body_Parameters.csv', index=False)


elif condition=='Control' and direction== 'Right':   
    Data.to_csv( str(Path(img_paths[f]).parents[2]) + '/' + condition + '_Right_Body_Parameters.csv', index=False)
